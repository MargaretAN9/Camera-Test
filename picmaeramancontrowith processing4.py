...
cv2.createTrackbar('Bstart','Trackbars',0,255,nothing)
cv2.createTrackbar('Bend','Trackbars',255,255,nothing)

cv2.createTrackbar('Gstart','Trackbars',0,255,nothing)
cv2.createTrackbar('Gend','Trackbars',255,255,nothing)

cv2.createTrackbar('Rstart','Trackbars',0,255,nothing)
cv2.createTrackbar('Rend','Trackbars',255,255,nothing)
...
#                f = cv2.cvtColor(image1,cv2.COLOR_RGB2GRAY)
...
#################################
 ...
 #               imgr = cv2.resize(image,None,fx=rsize, fy=rsize, interpolation = cv2.INTER_CUBIC)
                ...
                Bstart = cv2.getTrackbarPos('Bstart', 'Trackbars')
                Bend = cv2.getTrackbarPos('Bend', 'Trackbars')

                Gstart = cv2.getTrackbarPos('Gstart', 'Trackbars')
                Gend = cv2.getTrackbarPos('Gend', 'Trackbars')
        
                Rstart = cv2.getTrackbarPos('Rstart', 'Trackbars')
                Rend = cv2.getTrackbarPos('Rend', 'Trackbars')
...
#scale camera settings 
 ...
 #               combined = disp_multiple(blankimg,sharpened,result,image_blob)
                combined = disp_multiple(blankimg,image,image1,image_blob)
